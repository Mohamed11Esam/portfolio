import { ArrowRight, Bot, CheckCircle2, Code2, Cpu, ExternalLink, Globe, Layers, Radio, Sparkles, Terminal, Zap } from "lucide-react";
    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Left Column: Authoritative Architecting Headline */}
          <div className="lg:col-span-7">
            ...
            <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-zinc-900/90 border border-emerald-500/30 text-zinc-200 text-xs font-mono mb-6 shadow-lg shadow-emerald-950/20 backdrop-blur-md">
              ...
              <span className="text-emerald-400 font-semibold">Available for Full-Stack & Frontend Contracts</span>
            </div>

            {/* Restored Architecting Headline with Modern Frontends */}
            ...
            <p className="mt-6 text-base sm:text-lg text-zinc-300 leading-relaxed max-w-2xl font-normal">
              Hi, I'm <strong className="text-white font-semibold">{PROFILE.name}</strong>. I engineer fluid, responsive <span className="text-emerald-400 font-medium">React 19 & Next.js 15 frontends</span>, scalable <span className="text-teal-300 font-medium">Node/NestJS backends</span>, and enterprise <span className="text-cyan-400 font-medium">FastAPI RAG AI systems</span> that scale reliably from zero to enterprise load.
            </p>
          ...
          {/* Right Column: Live Interactive Architecture Preview Card */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-950/40 via-zinc-900 to-zinc-900 border border-emerald-500/20">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs font-mono text-emerald-400 font-semibold uppercase tracking-wider">
                        Client Frontend Ecosystem
                      </span>
                      <span className="text-xs font-mono text-zinc-400">React 19 + Zustand</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3.5 rounded-xl bg-zinc-900/60 border border-zinc-800/80">
                      ...
                      <div className="text-sm font-bold text-white font-mono">14ms Latency</div>
                      <div className="text-[11px] text-emerald-400">Socket.io Channel Active</div>
                    </div>
                    <div className="p-3.5 rounded-xl bg-zinc-900/60 border border-zinc-800/80">
                      <div className="flex items-center gap-2 text-xs text-zinc-400 font-mono mb-1">
